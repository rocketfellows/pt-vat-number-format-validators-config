...
namespace rocketfellows\PTVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\PTVatNumberFormatValidatorsConfig\PTVatNumberFormatValidatorsConfig;

class PTVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = PTVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = PTVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::PT(), $config->getCountry());
    }
